...
\newcommand{\titill}{Titill!!! Vantar hér}
...
\bibitem{equiv}
? \textit{Stopporð}. Retrieved March 30, 2026, from \href{https://github.com/atlijas/icelandic-stop-words/blob/master/all_stop_words.txt}{https://github.com/atlijas/icelandic-stop-words/blob/master/all_stop_words.txt}
\end{thebibliography}
